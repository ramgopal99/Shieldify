...
export function PasswordChecker() {
  ...
  return (
    <Card className="shadow-2xl border-4 border-primary rounded-lg bg-gradient-to-b from-gray-800 to-gray-900">
      ...
      <CardContent className="p-6 space-y-6">
        <div className="space-y-3">
          ...
          <Input
            ...
            className="border-2 border-gray-600 bg-gray-800 text-white focus:ring focus:ring-purple-500"
          />
        </div>
        <Button
